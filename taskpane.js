...
// Pełny HTML stopki + aktualna klauzula RODO + logowanie przez Office Dialog API + Microsoft Graph.
...
function buildSignatureHtml(user) {
  ...
  return "<br><br>" + cleanupPhoneLine(html);
}
